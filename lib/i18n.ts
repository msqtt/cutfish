...
const resources = {
  en: {
    translation: {
      app_title: 'Cutfish', wasm_powered: 'Private · WASM', upload_media: 'Import media',
      drop_here: 'Drop video, audio, or images here, or click to browse', media_assets: 'Media assets',
      import: 'Import', no_assets: 'No media yet. Import files to begin.', inspector: 'Inspector',
      ...
      split_unavailable: 'Move the playhead inside the selected material before cutting.', split_at_playhead: 'Cut selected material at playhead', cut: 'Cut', reset: 'Reset',
      ...
      timeline_audio_label: 'Audio segment {{name}}, starts at {{start}} seconds, {{duration}} seconds long. Click to select; drag to move.',
      timeline_audio_help: 'Click to select an audio segment; drag horizontally to move it, or use the left and right arrow keys to nudge by 0.1s (hold Shift for 1s).',
      ...
      video_track: 'Video', audio_track: 'Audio track', source_audio_track: 'Source audio', background_audio_track: 'Music & audio',
      tts_audio_track: 'Voice / TTS', linked_to_video: 'Linked to video', drop_audio_here: 'Drag an audio material here',
      subtitle_track: 'Captions', image_track: 'Images', effect_track: 'Visual effects',
      muted_state: 'Muted', audible_state: 'Audible',
      timeline_source_audio_label: 'Original audio from {{name}}, volume {{volume}} percent, {{state}}.',
      empty_track: 'No items',
      // Timeline relationships, add disclosure, and truthful title/count
      linked_timing: 'Linked timing', fixed_not_movable: 'Fixed, not movable',
      linked_timing_help: 'This item shares timing with a linked lane; moving either moves both.',
      fixed_item_help: 'This item is fixed to the project or clip structure and cannot be moved.',
      timeline_track_count_one: '{{count}} track', timeline_track_count_other: '{{count}} tracks',
      timeline_add: 'Add', timeline_add_menu: 'Add to timeline',
      add_caption: 'Caption', add_text_item: 'Text', add_image_item: 'Image',
      timeline_timed_label: '{{name}} on {{track}}, starts at {{start}} seconds, {{duration}} seconds long.',
      timeline_timed_help: 'Click to select; drag horizontally to move, or use the left and right arrow keys to nudge by 0.1s (hold Shift for 1s).',
      active_trim: 'Active trim', no_clip: 'No clip selected',
      export_mp4: 'Export MP4', export_webm: 'Export WebM', invalid_file: 'Choose at least one valid video, audio, or image file.',
      ...
      expand_timeline: 'Expand timeline', collapse_panel: 'Collapse panel', expand_panel: 'Expand panel',
      maximize_panel: 'Maximize panel', restore_panel: 'Restore panel',
      resize_media_panel: 'Resize media panel', resize_inspector_panel: 'Resize inspector panel', resize_timeline_panel: 'Resize timeline panel',
      // Transitions
      ...
      drag_to_timeline: 'Drag to timeline', add_to_timeline: 'Add to timeline', delete_audio_track: 'Delete audio material',
      audio_single_source_notice: 'This simple project keeps one external audio source; the first selected audio file was imported.',
      import_audio_from_media: 'Import audio from Media Assets, then drag it onto A2 or use Add to timeline.',
      project_audio_settings: 'Project audio settings', remove_source_audio: 'Remove source audio', restore_source_audio: 'Restore source audio',
      ...
      confirm_replace_audio: 'Importing another audio file will replace the current A2 source and all edited segments. Continue?',
      audio_preview_blocked: 'The browser blocked background-audio preview. Press Play again to allow sound.',
      replace_audio_source: 'Replace audio source',
      audio_segments: 'Segments', audio_segment_n: 'Segment {{n}}',
      no_audio_segments: 'No segments. Import audio to add one.',
      delete_audio_segment: 'Delete segment {{n}}',
      split_audio_segment: 'Split at playhead', add_audio_segment: 'Add segment', selected_segment: 'Selected segment', split: 'Split',
      audio_project_start: 'Project start', audio_trim_start: 'Trim start', audio_trim_end: 'Trim end',
      // Presets
      ...
      tts_model_info: 'Model: {{size}} MB · First use downloads through a validated mirror · Inference runs locally · Cached in browser OPFS',
      tts_media_private: 'Subtitle text and media are never uploaded.',
      tts_generation_failed: 'TTS generation failed. Please try again.',
      tts_model_download_failed: 'Voice model download failed. Check your connection and retry; invalid cached downloads will be repaired automatically.',
  ...
  zh: {
    translation: {
      app_title: 'Cutfish', wasm_powered: '隐私优先 · WASM', upload_media: '导入素材',
      drop_here: '拖入视频、音频或图片，或点击选择文件', media_assets: '媒体资源', import: '导入',
      no_assets: '还没有素材，导入文件即可开始。', inspector: '检查器', preview: '预览', trim: '裁剪',
      ...
      split_unavailable: '请先将播放头移到所选素材内部再进行切割。', split_at_playhead: '在播放头处切割所选素材', cut: '切割', reset: '重置',
      ...
      timeline_audio_label: '音频片段 {{name}}，起点 {{start}} 秒，时长 {{duration}} 秒。点击选中，拖动移动。',
      timeline_audio_help: '点击选中音频片段；横向拖动可移动，或用左右方向键以 0.1 秒微调（按住 Shift 为 1 秒）。',
      auto_saved: '已保存到本机', auto_save: '本地草稿已启用', play: '播放', pause: '暂停',
      back_five: '后退 5 秒', forward_five: '前进 5 秒', video_track: '视频', audio_track: '音频轨',
      source_audio_track: '视频原声', background_audio_track: '音乐与音频', tts_audio_track: '语音 / TTS',
      linked_to_video: '与视频联动', drop_audio_here: '把音频素材拖到这里',
      muted_state: '已静音', audible_state: '有声音',
      timeline_source_audio_label: '{{name}} 的视频原声，音量 {{volume}}%，{{state}}。',
      subtitle_track: '字幕', image_track: '图片', effect_track: '视觉效果', empty_track: '暂无元素',
      // Timeline relationships, add disclosure, and truthful title/count
      linked_timing: '联动时间', fixed_not_movable: '固定，不可移动',
      linked_timing_help: '该元素与联动轨共享时间，移动任一方都会同时移动。',
      fixed_item_help: '该元素固定于项目或片段结构，无法移动。',
      timeline_track_count_one: '{{count}} 条轨道', timeline_track_count_other: '{{count}} 条轨道',
      timeline_add: '添加', timeline_add_menu: '添加到时间轴',
      add_caption: '字幕', add_text_item: '文字', add_image_item: '图片',
      timeline_timed_label: '{{name}}，位于{{track}}，起点 {{start}} 秒，时长 {{duration}} 秒。',
      timeline_timed_help: '点击选中；横向拖动可移动，或用左右方向键以 0.1 秒微调（按住 Shift 为 1 秒）。',
      active_trim: '当前裁剪', no_clip: '未选择片段', export_mp4: '导出 MP4', export_webm: '导出 WebM',
      invalid_file: '请至少选择一个有效的视频、音频或图片文件。', import_in_progress: '已有导入任务正在进行。',
      ...
      expand_timeline: '展开时间轴', collapse_panel: '缩小面板', expand_panel: '展开面板',
      maximize_panel: '最大化面板', restore_panel: '还原面板',
      resize_media_panel: '调整媒体面板宽度', resize_inspector_panel: '调整检查器宽度', resize_timeline_panel: '调整时间轴高度',
      // Transitions
      ...
      drag_to_timeline: '拖到时间轴', add_to_timeline: '添加到时间轴', delete_audio_track: '删除音频素材',
      audio_single_source_notice: '简单项目当前保留一个外部音源，已导入所选的第一个音频文件。',
      import_audio_from_media: '请从「媒体资源」导入音频，再拖到 A2 或点击「添加到时间轴」。',
      project_audio_settings: '项目音频设置', remove_source_audio: '移除视频原声', restore_source_audio: '恢复视频原声',
      ...
      confirm_replace_audio: '导入另一音频会替换当前 A2 音源及全部已编辑片段，是否继续？',
      audio_preview_blocked: '浏览器阻止了背景音频预览，请再次点击播放以允许声音。',
      replace_audio_source: '替换音频源',
      audio_segments: '音频片段', audio_segment_n: '片段 {{n}}',
      no_audio_segments: '暂无片段，导入音频以添加。',
      delete_audio_segment: '删除片段 {{n}}',
      split_audio_segment: '在播放头处分割', add_audio_segment: '新增片段', selected_segment: '选中片段', split: '分割',
      audio_project_start: '项目起点', audio_trim_start: '裁剪起点', audio_trim_end: '裁剪终点',
      // Presets
      ...
      tts_progress: '{{percent}}%',
      tts_model_info: '模型：{{size}} MB · 首次使用通过校验镜像下载 · 推理完全本地 · 缓存在浏览器 OPFS',
      tts_media_private: '字幕文本和媒体不会被上传。',
      tts_generation_failed: 'TTS 生成失败，请重试。',
      tts_model_download_failed: '语音模型下载失败，请检查网络后重试；损坏的缓存会自动修复。',
