...
const resources = {
  en: {
    translation: {
      ...
      video_track: 'Video track', audio_track: 'Audio track', source_audio_track: 'Source audio', background_audio_track: 'Background audio',
      tts_audio_track: 'TTS narration', linked_to_video: 'Linked to video', drop_audio_here: 'Drag an audio material here',
      subtitle_track: 'Subtitle track', image_track: 'Image track', effect_track: 'Effect track',
  ...
  zh: {
    translation: {
      ...
      source_audio_track: '视频原声', background_audio_track: '背景音频', tts_audio_track: 'TTS 旁白',
      ...
      subtitle_track: '字幕轨', image_track: '图片轨', effect_track: '效果轨', empty_track: '暂无元素',
