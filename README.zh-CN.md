...
- **素材驱动的动态多轨时间轴**：V1 视频与 A1 视频原声为联动配对；拖动任一轨道都会通过 Pointer Events 重排整对素材，并提供可见把手和 Alt+方向键回退。A2 背景音频、A3 本地 TTS 旁白、S1 字幕、I1 图片和 FX 效果仅在存在素材时出现；选择驱动上下文检查器，Cut/Delete 作用于播放头处所选素材
